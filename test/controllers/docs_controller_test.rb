...
class DocsControllerTest < ActionController::TestCase
  ...
  test "should create doc" do
    assert_difference('Doc.count') do
      post :create, doc: { address: @doc.address, city: @doc.city, content: @doc.content, title: @doc.title }
    end
  ...
  test "should update doc" do
    patch :update, id: @doc, doc: { address: @doc.address, city: @doc.city, content: @doc.content, title: @doc.title }
    assert_redirected_to doc_path(assigns(:doc))
  end
